...
from models.train_test_lstm import *
from models.GGATLSTM import *
...
if __name__ == '__main__':
    ...
    # # Hyperparameters
    hidden_size, num_layersGAT, num_layersGRU, expansion,  n_heads = 256, 1, 1, 2, 16

    learning_rate, schd_stepzise, gamma, epochs, batch_size, patience_limit, clip= 2e-4, 25, 0.25, 350, 64, 50, 1
    ...
    Nusers, NZones = 32, 10
    Nnodes, NTrfL, sl, future, sw, sn  = Nusers, 4, 10, 15, 2, 10
    Centre = [512,512]
    downsamplesc, downsampletar = 1,2
    ...
    parser.add_argument('--downsamplesc', type=int, default=downsamplesc, help='downsample')
    parser.add_argument('--downsampletar', type=int, default=downsampletar, help='downsample')
